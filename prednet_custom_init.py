# This code was modified by Yamini to accept a custom initial state to examine the generative model made by the prednet
# To do this, the call function from Recurrent was overloaded to accept a custom_initial
...
custom_initial: Custom initial state provided by the user for the R layers.fjand
